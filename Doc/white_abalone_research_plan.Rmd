...
In 2008, NOAA finalized the White Abalone Recovery Plan [hereafter, Recovery Plan; @NationalMarineFisheriesService2008]. That document describes the status of the species, goals for recovery throughout its range, and the recommendd strategy to achieve recovery, including:  
